...
const Menu = ({ routes }) => {
  ...
  return (
    <div>
      <Link style={padding} to={routes[0]}>anecdotes</Link>
      <Link style={padding} to={routes[1]}>create new</Link>
      <Link style={padding} to={routes[2]}>about</Link>
    </div>
  )
}
...
const CreateNew = (props) => {
  ...
  const handleReset = (e) => {
    props.content.onChange({ target:{ value:'' } })
